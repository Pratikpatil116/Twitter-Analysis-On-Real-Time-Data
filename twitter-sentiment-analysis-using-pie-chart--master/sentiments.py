...
class SentimentAnalysis:
    ...
    def DownloadData(self, keyword, tweets):
        ...
        # authenticating
        consumerKey = 'tfH5NYUhi6mln60JDYRuqjrKn'
        consumerSecret = 'ViD4tBKoqSs5KgTZBoRJIFvsieJ9SevTLQAWWwvvE5K5FJC7kr'
        accessToken = '1194914448793686018-jpzibdUZ7yJybMK75IgEyt90LOTXc1'
        accessTokenSecret = 'fvT8uV70okmdUcQ8SEGG4PE8jHTI3PMEui6jIxpvZWBtW'
    ...
    def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, keyword, tweets):
        ...
        plt.axis('equal')
        plt.tight_layout()
        strFile = r"C:\Users\swami\Downloads\twitter-sentiment-analysis-using-pie-chart--master\twitter-sentiment-analysis-using-pie-chart--master\static\images\plot1.png"
